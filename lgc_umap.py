...
data = pd.read_csv('data/lgc/processed_lgc.csv')
...
# umap_reducer = umap.UMAP(n_components=2, n_neighbors=15, min_dist=0.1, random_state=31)
# umap_reducer = umap.UMAP(n_components=2, n_neighbors=15, min_dist=0.1, random_state=50)
# umap_reducer = umap.UMAP(n_components=2, n_neighbors=15, min_dist=0.1, random_state=71)
# umap_reducer = umap.UMAP(n_components=2, n_neighbors=15, min_dist=0.1, random_state=1208)
# umap_reducer = umap.UMAP(n_components=2, n_neighbors=30, min_dist=0.1, random_state=37)
# umap_reducer = umap.UMAP(n_components=2, n_neighbors=30, min_dist=0.1, random_state=73)
...
plt.savefig('results/lgc/umap_lgc.png')
plt.show()
